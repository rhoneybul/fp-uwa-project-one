...
/* package web-service-0.1.0.0 */
#define VERSION_web_service "0.1.0.0"
#define MIN_VERSION_web_service(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "web-service-0.1.0.0"

#define CURRENT_PACKAGE_KEY "web-service-0.1.0.0"
